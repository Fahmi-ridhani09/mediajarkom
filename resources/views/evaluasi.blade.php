...
<head>
    ...
    <style>
        ...
        body {
            background-color: #fdf6f0; /* coklat muda keputihan */
            color: #4b2e1e; /* teks coklat tua */
        }
    
        .navbar, .card-header, .btn-primary, .modal-header {
        ...
        .badge.bg-success {
            background-color: #b56f3c !important; /* badge jawaban */
        }
...
<div class="container">
    <div class="row mt-3">
        ...
        `
                ...
                footer += `<a href="materi/halamanmateri"  class="btn btn-secondary">Kembali ke Materi!</a>`
                if(nilai >= 70){
